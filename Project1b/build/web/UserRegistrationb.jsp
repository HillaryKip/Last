...
<body style="overflow-x: hidden; background-color: #EFEEEE;"> 
    ...
    int results2=reg.setUsers(fname, mname, lname, email, pwd);
        ...
        <div class="panel-heading">
               <h3 class="panel-title" style="text-align: center;"><span style="color: red;">Email You Provided is Already Registered!!</span></h3>
        </div> 
       <% }
        else{
            ...
            if(results2>0){%>
            <div class="panel-heading">
               <h3 class="panel-title" style="text-align: center;"><span style="color: green;">Registration Successful... Click Sign In below to Login</span></h3>
            </div> 
     <% }
       else{%>
       <div class="panel-heading">
               <h3 class="panel-title" style="text-align: center;"><span style="color: red;">Server is Down!!</span></h3>
       </div> 
         <% }
    }
    }
